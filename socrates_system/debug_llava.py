...
def test_llava_model_loading():
    ...
    try:
        ...
        models_to_test = [
            ...
            ("llava-hf/llava-1.5-13b-hf", True, False),  # Try 13B model
        ]
        ...
        for model_name, no_4bit, use_slow_tokenizer in models_to_test:
            ...
            try:
                ...
                test_image = "/Users/mohammed/Desktop/Socrates/Socrates/socrates_system/mllm_evaluation/datasets/MME_Benchmark/OCR/images/0001.jpg"
